...
class Assignment
  ...
  def find_allusers(offset, limit)
      ...
      @users = User.offset(offset).limit(limit).all.order(:updated_at)
  end
  ...
  def find_alllists(offset, limit)
      ...
      @lists = TodoList.offset(offset).limit(limit).all.order(list_due_date: :desc)
  end
  ...
  def find_todolist_byname(name)
      ...
      @lists = TodoList.where(list_name: name)
  end     
  ...
  def update_password(id, password_digest)
      ...
      @user = User.find(id).update(password_digest: password_digest)
  end
  ...
  def update_listname(id, name)
      ...
      # (no return is required)
      @list = TodoList.find(id).update(list_name: name)
  end 
